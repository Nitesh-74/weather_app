...
const fetchData = async (target) => {
  try {
    const url = `https://api.weatherapi.com/v1/current.json?key=1caab3da59294431ab0182233230707&q=${target}`;
    // https://api.weatherapi.com/v1/current.json?key=1caab3da59294431ab0182233230707&q=delhi
